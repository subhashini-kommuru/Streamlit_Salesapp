...
if p_value < 0.05:
    st.write("Reject the null hypothesis: The mean units sold is  significantly difference from 20.")
else:
    st.write("Fail to reject the null hypothesis: The mean units sold is not significantly difference 20.")
